...
export class ReferralService {
  ...
  getReferraldData(sort: string, order: string, page: number, range: any,level :any,date: any): Observable<any> {
    if ( page ==0) {
      this.pageIndex = page;
      this.counterPage = 0
    } else {
  ...
  setReferrer(data : any){
    return this._globals.postMethod('/save-referrer', data)
  }
