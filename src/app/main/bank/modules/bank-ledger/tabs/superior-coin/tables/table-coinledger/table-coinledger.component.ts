...
@Component({
  selector: 'app-bank-table-coinledger',
  templateUrl: './table-coinledger.component.html',
  styleUrls: ['./table-coinledger.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class BankCoinLedgerTableComponent implements OnInit {

  displayedColumns = ['amount', 'fee', 'tx_id', 'txn_date', 'description', 'status'];
    ...
    merge(this.sort.sortChange, this.paginator.page)
      .pipe(startWith({}),
        ...
        map(data => {
          ...
          this.resultsLength = decodedData.length;
