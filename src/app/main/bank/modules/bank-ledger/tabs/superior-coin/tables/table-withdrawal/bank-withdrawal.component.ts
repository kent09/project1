...
import { BANK_API , SuperCoinHttpRequest } from 'app/main/bank/modules/bank-ledger/tabs/superior-coin/tables/table-withdrawal/bank-withdrawal.service';

@Component({
  selector: 'app-bank-table-withdrawal',
  templateUrl: './bank-withdrawal.component.html',
  styleUrls: ['./bank-withdrawal.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class BankWithdrawalTableComponent implements OnInit {

  displayedColumns = ['amount', 'fee', 'tx_id', 'txn_date', 'description', 'status', 'options'];
