...
export class OptionTradeService {
  ...
  getBankOptionTrade(sort: string, order: string, page: number, search:any, filter_date : any): Observable<any> {
    ...
    return this._globals.postMethod(`/bank/basic-ledger/btc/option-trade`, data);
  }
}
