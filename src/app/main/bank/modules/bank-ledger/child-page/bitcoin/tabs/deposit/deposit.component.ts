...
export class DepositComponent implements OnInit {
  ...
  displayedColumns = ['date_received','amount','address','tx_id', 'status'];
  exampleDatabase: DepositService | null;
  data: BANKDEPOSITAPI[] = [];
  ...
  ngOnInit() {
    ...
    this.exampleDatabase = new DepositService(this.http, this._globals, this._auth);
