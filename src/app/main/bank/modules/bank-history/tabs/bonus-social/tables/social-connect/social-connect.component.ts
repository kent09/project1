...
import { BANK_API , SuperCoinHttpRequest } from 'app/main/bank/modules/bank-history/tabs/bonus-social/tables/social-connect/social-connect.service';

@Component({
  selector: 'app-bank-social-connect',
  templateUrl: './social-connect.component.html',
  styleUrls: ['./social-connect.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class BankSocialConnectTableComponent implements OnInit {

  displayedColumns = ['social_media_type', 'account_username', 'connected_date', 'reward', 'status'];
