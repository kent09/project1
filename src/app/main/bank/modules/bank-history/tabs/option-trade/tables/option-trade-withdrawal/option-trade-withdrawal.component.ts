...
import { BANK_API , SuperCoinHttpRequest } from 'app/main/bank/modules/bank-history/tabs/option-trade/tables/option-trade-withdrawal/option-trade-withdrawal.service';

@Component({
  selector: 'app-bank-option-trade-withdrawal',
  templateUrl: './option-trade-withdrawal.component.html',
  styleUrls: ['./option-trade-withdrawal.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class BankOptionTradeWithdrawalTableComponent implements OnInit {
