...
import { BANK_API , SuperCoinHttpRequest } from 'app/main/bank/modules/bank-history/tabs/referral-points/tables/referral-third-level/referral-third-level.service';
import { ThirdLevelComponent } from '../modal/third-level/third-level.component';

@Component({
  selector: 'app-bank-referral-third-level',
  templateUrl: './referral-third-level.component.html',
  styleUrls: ['./referral-third-level.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class BankReferralThirdTableComponent implements OnInit {
  ...
  openDialog(details): void {
    const dialogRef = this._dialog.open(ThirdLevelComponent, {
      data: details
    });
